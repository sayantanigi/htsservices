...
class HtsUsersController extends Controller {
    ...
    */
    public function agent_list(Request $request) {
        ...
        $query->join('hts_user_types', 'hts_users.user_type', '=', 'hts_user_types.id') ->select(DB::raw('hts_users.*, hts_user_types.name as t_name')) ->where('hts_user_types.id','1');
    ...
    public function addAgent($user_type) {
        ...
        if (Session::has('hts_user_id')) {
            ...
            $query_carrier_rates = DB::table('hts_querycarrierrates')->where('hts_user_id', $hts_user_id)->orderBy('id', 'desc')->get();
        ...
        if (Session::has('hts_user_id')) {
            //$hts_rate_id = Session::get('hts_rate_id');
            // do some thing if the key is exist
            $qsrateArray = DB::table('hts_querycarrierrates')->where('hts_user_id', $hts_user_id)->first();
            $qscarrier_rates = DB::table('hts_querycarrierrates')->where('hts_user_id', $hts_user_id)->orderBy('id', 'desc')->get();
            $isqsRateStatusCompleted = DB::table('hts_querycarrierrates')->where('hts_user_id', $hts_user_id)->where('status', '1')->count();
            if($isqsRateStatusCompleted>0) {
                // Session::put('carrier_cont_id_notes', $hts_cont_id);
                Session::forget('hts_rate_id');
                $qrateArray = [];
            }
        ...
        if(!empty($hts_user_id)) {
            ...
            $all_salesusers = DB::table('hts_users')->where('user_type', '5')->whereNotIn('id', $notInArray)->orderBy('id','desc')->get();
            $all_agentusers = DB::table('hts_users')->where('user_type', '4')->whereNotIn('id', $notInArray)->orderBy('id','desc')->get();
            ...
            $all_salesusers = DB::table('hts_users')->where('user_type', '5')->orderBy('id','desc')->get();
            $all_agentusers = DB::table('hts_users')->where('user_type', '4')->orderBy('id','desc')->get();
        ...
        $data = array(
            ...
            'all_users' => $all_users,
            'all_salesusers' => $all_salesusers,
            'all_agentusers' => $all_agentusers,
            'cr_notes' => $cr_notes,
    ...
    public function createHtsRateGround(Request $request)
    {
        ...
        if (Session::has('hts_rate_id')) {
            $dataArray = [
                'hts_rate_method' => $request->hts_rate_method,
    ...
    public function updateHtsParentEntity(Request $request) {
        ...
        $affected = DB::table('hts_users')->where('id', $hts_user_id)->update($dataArray);
    ...
    public function updateHtsSalesPerson(Request $request) {
        $hts_user_id = Session::get('hts_user_id');
        $hts_user_type = Session::get('hts_user_type');
        $dataArray = [
    ...
    public function updateSalesPersonEdt(Request $request) {
        $hts_user_id = $request->carrier_id;
        $dataArray = [
            'sales_person' => $request->sales_person,
            'updated_at' => date('Y-m-d h:i:s')
    ...
    public function updateHtsDestinationAgent(Request $request) {
        $hts_user_id = Session::get('hts_user_id');
        $hts_user_type = Session::get('hts_user_type');
        $dataArray = [
    ...
    public function updateHtsDestinationAgentEdt(Request $request) {
        $hts_user_id = $request->carrier_id;
        $dataArray = [
            'destination_agent' => $request->destination_agent,
            'updated_at' => date('Y-m-d h:i:s')
    ...
    public function updateHtsOtherAddress(Request $request) {
        ...
        $dataArray = [
            ...
            'other_contact_phone' => $request->other_contact_phone,
            'other_contact_phone_code' => $request->other_contact_phone_code,
            'other_contact_fax' => $request->other_contact_fax,
        ...
        $affected = DB::table('hts_other_address')->insert($dataArray);
    ...
    public function saveHtsOtherAddress(Request $request)
    {
        ...
        $dataArray = [
            ...
            'other_contact_phone' => $request->other_contact_phone_edt,
            'other_contact_phone_code' => $request->other_contact_phone_code_edt,
            'other_contact_fax' => $request->other_contact_fax_edt,
            'other_contact_email' => $request->other_contact_email_edt,
    ...
    public function deleteHtsQSRateGroundTabData(Request $request, $id)
    {
        $hts_user_id = Session::get('hts_user_id');
        $hts_user_type = Session::get('hts_user_type');
        $delete = DB::table('hts_querycarrierrates')->where('id', $id)->delete();
        if (!$delete) {
            $type = "error";
            $msg = 'Query carrier rates has not been deleted ';
        } else {
            $type = "success";
            $msg = 'Quick carrier rates record has been deleted successfully. ';
        }
        Session::flash($type, $msg);
        return redirect('add-agent/'.$hts_user_type);
    }
    ...
    public function createAwbNumber(Request $request) {
        $hts_user_id = Session::get('hts_user_id');
        $hts_user_type = Session::get('hts_user_type');
        if($request->range_waybillno == '1') {
            $start = $request->start_awb_number_range;
            $end = $request->end_awb_number_range;
        } else {
            $start = $request->start_awb_number_amount;
            $end = $request->end_awb_number_amount;
        }
        if ($start >= $end) {
