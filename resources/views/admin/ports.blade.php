                                                ...
                                                <div class="row">
                                                    <div class="col-lg-10">
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <select class="form-select select2" required aria-label="Default select example" name="port_country_edt" id="port_country_edt_{{ $row->id }}">
                                                                <option value="" selected="">Select Country...</option>
                                                                @if (!$data['countries']->isEmpty())
                                                                @foreach ($data['countries'] as $key => $item_val)
                                                                <option value="{{ @$item_val->id }}" {{ @$item_val->id == @$row->country_id ? 'selected' : '' }}> {{ @$item_val->name }}</option>
                                                                @endforeach
                                                                @endif
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-10">
                                                        <div class="form-group mb-3">
                                                            <div class="form-check">
                                                                ...
                                                                <label class="form-check-label" for="used_by_company">This port is used by my company</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-10">
                ...
                <form action="{{ route('createPort') }}" method="post" enctype="multipart/form-data" id="loginForm">
                    ...
                    <div class="row">
                        <div class="col-lg-10">
                            <div class="form-group mb-3">
                                <label>Country<code>*</code></label>
                                <select class="form-select select2" aria-label="Default select example" name="port_country" id="port_country">
                                    <option value="" selected="">Select Country...</option>
                                    @if (!$data['countries']->isEmpty())
                                    @foreach ($data['countries'] as $key => $item_val)
                                    <option value="{{ @$item_val->id }}" {{ @$item_val->id == @$data['carrierData']->country ? 'selected' : '' }}>{{ @$item_val->name }}</option>
                                    @endforeach
                                    @endif
                                </select>
                            </div>
