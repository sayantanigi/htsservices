                ...
                <div class="card custom-shadow rounded-lg border">
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs nav-tabs-cus" role="tablist" id="myAccordion">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" {{ Session::has('employee_id') ? '' : 'disabled' }} data-bs-toggle="tab"
                        ...
                        <div class="tab-content p-3 text-muted">
                            ...
                            <div class="tab-pane active" id="generale" role="tabpanel">
                                <form action="{{ route('createUser') }}" class="custom-validation" method="post"
                                    id="formValidated">
                                    @csrf
                                    <div class="row">
                                        <div class="col-lg-3">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="password" class="form-control" name="password" id="password" placeholder="******" value="{{ @$data['userData']->encoded_password ? base64_decode($data['userData']->encoded_password) : '' }}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <label>Divison </label>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="password" class="form-control" name="confirm_password" placeholder="******" value="{{ @$data['userData']->encoded_password ? base64_decode($data['userData']->encoded_password) : '' }}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                            ...
                            <div class="tab-pane " id="relatedentitiese" role="tabpanel">
                                <form action="{{ route('updateParentEntityEmp') }}" class="custom-validation" method="post"
                            ...
                            <div class="tab-pane " id="addresse" role="tabpanel">
                                <form action="{{ route('updateUsrAddress') }}" class="custom-validation"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <button type="reset"
                                                                    ...
                                                                    onclick="deleteUsrOtherAddress({{ $row->id }});">
                                                            ...
                                                            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form
                                                                            action="{{ route('saveEmployeeOtherAddress') }}"
                                        ...
                                        <div class="col-12">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div>
                                                        <form action="{{ route('upload-employee-images') }}"
                                                            class="form-horizontal form dropzone" method="post"
                                                            id="formValidatedEmployeeGallery">
                                                            @csrf
                                                            <div class="fallback">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <button
                                                                                                ...
                                                                                                onclick="deleteEmployeeImage({{ @$row->id }})"><i
                            ...
                            <div class="tab-pane " id="notese" role="tabpanel">
                                <div class="rates_main">
                                    <form action="{{ route('addUsrNote') }}" class="custom-validation"
        ...
        <div class="modal fade" id="otherserviceadd" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('updateUsrOtherAddress') }}" class="custom-validation"
