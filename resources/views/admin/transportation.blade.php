                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="square-switch">
                                    <input type="checkbox" id="square-switch{{ @$row->id }}" value="{{ @$row->status }}" switch="info" {{ (@$row->status == 1)? 'checked="checked"' : '' }} onchange="changeTransportationStatus({{ @$row->id }}, $(this))" />
                              ...
                              <td>
                                 ...
                                 <button class="btn btn-sm btn-danger" onclick="deleteTransportation({{ @$row->id }})"><i class="fas fa-trash-alt"></i></button>
                              </td>
                           </tr>
                              ...
                              <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                       <form action="{{ route('updateTransportation') }}" method="post" enctype="multipart/form-data" id="formValidated">
                                          @csrf
                                          ...
                                          <div class="row">
                                             <div class="col-lg-12">
                                                <div class="form-group mb-3">
                                                   <label class="fw-bold font-size-13">Method:</label>
                                                   {{-- <input type="text"  value="{{ $row->method }}" required class="form-control" name="carrier_method_edt" id="carrier_method_edt"> --}}
                                                   <select class="form-control form-select select2" name="carrier_method_edt" id="carrier_method_edt">
                                                      <option value="">Choose...</option>
                                                      <option value="Air" {{ $row->method=="Air" ? 'selected' : '' }}>Air</option>
                                                      <option value="Ocean" {{ $row->method=="Ocean" ? 'selected' : '' }}>Ocean</option>
                                                      <option value="Ground" {{ $row->method=="Ground" ? 'selected' : '' }}>Ground</option>
                                                   </select>
                                                </div>
                                             </div>
                                          </div>
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" style="display: none;" aria-hidden="true">
   <div class="modal-dialog" role="document">
       <div class="modal-content">
           <div class="modal-header">
               <h5 class="modal-title" id="staticBackdropLabel">Add new transportation</h5>
               <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
           </div>
           <div class="modal-body">
            <form action="{{ route('createTransportation') }}" method="post" enctype="multipart/form-data" id="validateForm">
               @csrf
               ...
               <div class="row">
                  <div class="col-lg-12">
                     <div class="form-group mb-3">
                        <label class="fw-bold font-size-13">Method:</label>
                        <select class="form-control form-select select2" name="carrier_method" id="carrier_method">
                           <option value="">Choose...</option>
