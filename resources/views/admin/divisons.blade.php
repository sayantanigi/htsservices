                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="square-switch">
                                    <input type="checkbox" id="square-switch{{ @$row->id }}" value="{{ @$row->status }}" switch="info" {{ (@$row->status == 1)? 'checked="checked"' : '' }} onchange="changeDivisonStatus({{ @$row->id }}, $(this))" />
                              ...
                              <td>
                                 ...
                                 <button class="btn btn-sm btn-danger" onclick="deleteDivison({{ @$row->id }})"><i class="fas fa-trash-alt"></i></button>
                              </td>
                           </tr>
                              ...
                              <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                       <form action="{{ route('updateDivison') }}" method="post" enctype="multipart/form-data" id="formValidated">
                                          @csrf
                                          <input type="hidden" name="divison_id" id="divison_id" value="{{ $row->id }}">
                                          <div class="row">
                                             <div class="col-lg-10">
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" style="display: none;" aria-hidden="true">
   <div class="modal-dialog" role="document">
       <div class="modal-content">
           <div class="modal-header">
               <h5 class="modal-title" id="staticBackdropLabel">Add new divison</h5>
               <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
           </div>
           <div class="modal-body">
            <form action="{{ route('createDivison') }}" method="post" enctype="multipart/form-data" id="loginForm">
               @csrf
               ...
               <div class="row">
                  <div class="col-lg-10">
                     <div class="form-group mb-3">
                        <label class="fw-bold font-size-13">Name:</label>
                        <input type="text"  value="" class="form-control" name="divison_name" id="divison_name">
                     </div>
                  </div>
               </div>
