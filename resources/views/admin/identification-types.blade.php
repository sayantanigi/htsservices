...
@section('title', 'Identification Type List')
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="square-switch">
                                    <input type="checkbox" id="square-switch{{ @$row->id }}" value="{{ @$row->status }}" switch="info" {{ (@$row->status == 1)? 'checked="checked"' : '' }} onchange="changeIdentiTypeStatus({{ @$row->id }}, $(this))" />
                              ...
                              <td>
                                 ...
                                 <button class="btn btn-sm btn-danger" onclick="deleteIdentificationType({{ @$row->id }})"><i class="fas fa-trash-alt"></i></button>
                              </td>
                           </tr>
                              ...
                              <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                       <form action="{{ route('updateIdentification') }}" method="post" enctype="multipart/form-data" id="formValidated">
                                          @csrf
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" style="display: none;" aria-hidden="true">
   <div class="modal-dialog" role="document">
       <div class="modal-content">
           ...
           <div class="modal-body">
            <form action="{{ route('createType') }}" method="post" enctype="multipart/form-data" id="loginForm">
               @csrf
               ...
               <div class="row">
                  <div class="col-lg-10">
                     <div class="form-group mb-3">
                        <label class="fw-bold font-size-13">Name:</label>
                        <input type="text"  value="" class="form-control" name="type_name" id="type_name">
                     </div>
                  </div>
               </div>
