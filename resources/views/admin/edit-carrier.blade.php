                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content p-3 text-muted">
                                ...
                                <div class="tab-pane active" id="generalce" role="tabpanel">
                                    <form action="{{ route('updateCarrierData') }}" class="custom-validation" method="post"
                                        id="formValidated">
                                        @csrf
                                ...
                                <div class="tab-pane " id="addressce" role="tabpanel">
                                    <form action="{{ route('updateCarrierEdtAddress') }}" class="custom-validation"
                                ...
                                <div class="tab-pane" id="billingce" role="tabpanel">
                                    <form action="{{ route('updateCarrierBillingAddressEdt') }}" class="custom-validation"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <button type="reset"
                                                                        ...
                                                                        onclick="deleteOtherAddressEdt({{ $row->id }});">
                                                                ...
                                                                <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form action="{{ route('saveCarrierOtherAddressEdt') }}" class="custom-validation"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="table-responsive">
                                                        <div style="max-height: 450px; overflow-y: auto;">
                                                            <form action="{{ route('updateParentEntityEdt') }}" class="custom-validation" method="post"
                                ...
                                <div class="tab-pane " id="contactsce" role="tabpanel">
                                    <div class="rates_main">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <h4 class="card-title mb-3">Contact lists
                                                        <button type="button" style="float: right;" data-bs-toggle="modal" data-bs-target=".bs-example-modal-edt-xl"
                                                            class="btn btn-primary btn-sm waves-effect waves-light">
                                                                ...
                                                                @foreach ($data['carrier_contacts'] as $key => $row)
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <button type="reset"
                                                                                class="btn btn-danger btn-sm waves-effect"
                                                                                onclick="deleteConTabDataEdt({{ $row->id }});">
                                                                                <i class="fas fa-trash"></i> Delete
                                                                            </button>
                                                                        </td>
                                                                    </tr>
                                        ...
                                        <div class="modal fade bs-example-modal-edt-xl" id="myModal" role="dialog" aria-labelledby="addcontactdetails" aria-hidden="true">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="tab-content p-3 text-muted">
                                                                    ...
                                                                    <div class="tab-pane active" id="cgeneral" role="tabpanel">
                                                                        <form action="{{ route('createCarrierContactEdt') }}" class="custom-validation" method="post"
                                                                    ...
                                                                    <div class="tab-pane" id="caddress" role="tabpanel">
                                                                        <form action="{{ route('updateConCarrierAddressEdt') }}" class="custom-validation"
                                                                    ...
                                                                    <div class="tab-pane " id="cbaddress" role="tabpanel">
                                                                        <form action="{{ route('updateCarrierConBillingAddressEdt') }}" class="custom-validation"
                                                                    ...
                                                                    <div class="tab-pane " id="coaddress" role="tabpanel">
                                                                        <form action="{{ route('updateCarrierContOtherAddressEdt') }}" class="custom-validation"
                                                                    ...
                                                                    <div class="tab-pane " id="cpinfo" role="tabpanel">
                                                                        <form action="{{ route('updateCarrierContDateOfBirthEdt') }}" class="custom-validation"
                                                                    ...
                                                                    <div class="tab-pane " id="cattachment" role="tabpanel">
                                                                        <div>
                                                                            <form action="{{ route('upload-images-edt') }}" class="form-horizontal form dropzone" method="post" id="formValidatedConCarrierGalleryEdt">
                                                                                @csrf
                                                                                <input type="hidden" name="carrier_id" id="carrier_id_edt" value="{{ @$data['carrier_id'] }}">
                                                                                <div class="fallback">
                                                                                           ...
                                                                                           @if(!empty($data['contact_gallery']))
                                                                                              @foreach($data['contact_gallery'] as $key=>$row)
                                                                                                 ...
                                                                                                 <tr>
                                                                                                    ...
                                                                                                    <td>
                                                                                                       <button class="btn btn-xs btn-danger" onclick="deleteListingImageEdt({{ @$row->id }})"><i class="fas fa-trash-alt"></i></button>
                                                                                                    </td>
                                                                                                 </tr>
                                                                                              @endforeach
                                                                                           @endif
                                                                    ...
                                                                    <div class="tab-pane " id="cnotes" role="tabpanel">
                                                                        <div class="rates_main">
                                                                            <form action="{{ route('create-notes-edt') }}" class="form-horizontal form" method="post" id="formValidatedBillingAddress2ndTab_4">
                                                                                @csrf
                                                                                <input type="hidden" name="carrier_id" value="{{ @$data['carrier_id'] }}">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td>
                                                                                                            ...
                                                                                                            <button type="button" class="btn btn-danger btn-sm waves-effect"
                                                                                                                onclick="deleteConNoteEdt({{ $row->id }});">
                                                                                                                <i class="fas fa-trash"></i> Delete
                                                                                                            </button>
                                                                                                        </td>
                                                                                                    ...
                                                                                                    <div class="modal fade" id="editConNote-{{ $row->id }}" tabindex="-1" role="dialog"
                                                                                                        ...
                                                                                                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                                                                                            <div class="modal-content">
                                                                                                                ...
                                                                                                                <div class="modal-body">
                                                                                                                    <form action="{{ route('saveCarrierConNoteEdit') }}" class="custom-validation"
                                                                                                                        method="post" id="formValidatedOtherAddress">
                                                                                                                        @csrf
                                ...
                                <div class="tab-pane " id="landce" role="tabpanel">
                                    ...
                                    @if ($data['title']=="Air Carrier")
                                        <form action="{{ route('updateAirCarrierCodeEdt') }}" class="custom-validation" method="post" id="formValidatedirline">
                                            @csrf
                                            <input type="hidden" name="carrier_id" value="{{ @$data['carrier_id'] }}">
                                            <div class="row mb-3">
                                    ...
                                    <div class="modal fade bs-example-modal-lg" id="addLandCode" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="table-responsive">
                                                        <form action="{{ route('updateLandCarrierCodeEdt') }}" class="custom-validation" method="post" id="formValidatedParentEntity">
                                                            @csrf
                                                            <input type="hidden" name="carrier_id" value="{{ @$data['carrier_id'] }}">
                                    ...
                                    <div class="modal fade bs-example-modal-lg" id="addOceanCode" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="table-responsive">
                                                        <form action="{{ route('updateOceanCarrierCodeEdt') }}" class="custom-validation" method="post" id="formValidatedParentEntity">
                                                            @csrf
                                                            <input type="hidden" name="carrier_id" value="{{ @$data['carrier_id'] }}">
                                                                ...
                                                                @foreach ($data['carrier_rates'] as $key => $row_val)
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <button type="reset"
                                                                                class="btn btn-danger btn-sm waves-effect"
                                                                                onclick="deleteRateGroundTabDataEdt({{ $row_val->id }});">
                                                                                <i class="fas fa-trash"></i> Delete
                                                                            </button>
                                                                        </td>
                                                                    </tr>
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="tab-content p-3 text-muted">
                                                                    ...
                                                                    <div class="tab-pane active" id="rgeneral" role="tabpanel">
                                                                        <form action="{{ route('createCarrierRateGroundEdt') }}" class="custom-validation" method="post"
                                                                    ...
                                                                    <div class="tab-pane " id="rpinfo" role="tabpanel">
                                                                        <form action="{{ route('updateCarrierRateContractEdt') }}" class="custom-validation"
                                                                            method="post" id="formValidatedBillingAddress2ndTab_3">
                                                                            @csrf
                                                                            <input type="hidden" name="carrier_id" value="{{ @$data['carrier_id'] }}">
                                                                            <div class="row">
                                                                    ...
                                                                    <div class="tab-pane " id="rnotes" role="tabpanel">
                                                                        <div class="rates_main">
                                                                            <form action="{{ route('create-rate-notes-edt') }}" class="form-horizontal form" method="post" id="formValidatedBillingAddress2ndTab_4">
                                                                                @csrf
                                                                                <input type="hidden" name="carrier_id" value="{{ @$data['carrier_id'] }}">
                                                                                <div class="row row-border-bottom mt-3 mb-3">
                                                                                    <div class="col-lg-6">
                                                            ...
                                                            @foreach ($data['carrier_charges'] as $key => $row_val)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <button type="reset"
                                                                            class="btn btn-danger btn-sm waves-effect"
                                                                            onclick="deleteChargeTabDataEdt({{ $row_val->id }});">
                                                                            <i class="fas fa-trash"></i> Delete
                                                                        </button>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="tab-content p-3 text-muted">
                                                                        ...
                                                                        <div class="tab-pane active" id="chgeneral" role="tabpanel">
                                                                            <form action="{{ route('createCustomCarrierChargeEdt') }}" class="custom-validation" method="post"
                                                                        ...
                                                                        <div class="tab-pane " id="chinfo" role="tabpanel">
                                                                            <form action="{{ route('createCustomChargeAutoCreationEdt') }}" class="custom-validation" method="post"
                                ...
                                <div class="tab-pane " id="pmttemsce" role="tabpanel">
                                    <div class="rates_main">
                                        <form action="{{ route('updateCarrierPmtTermsEdt') }}" class="custom-validation"
                                            method="post" id="formValidatedAddress">
                                            @csrf
                                            <input type="hidden" name="carrier_id" value="{{ @$data['carrier_id'] }}">
                                            <div class="form-group mb-3">
                                            ...
                                            <div class="col-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div>
                                                            <form action="{{ route('upload-carrier-images-edt') }}" class="form-horizontal form dropzone" method="post" id="formValidatedCarrierGalleryEdt">
                                                                @csrf
                                                                <input type="hidden" name="carrier_id" id="attach_carrier_id" value="{{ @$data['carrier_id'] }}">
                                                                <div class="fallback">
                                                                    <input name="file" type="file" multiple="multiple">
                                                                </div>
                                                                <div class="dz-message needsclick">
                                                                               ...
                                                                               @if(!empty($data['gallery']))
                                                                                  @foreach($data['gallery'] as $key=>$row)
                                                                                     ...
                                                                                     <tr>
                                                                                        ...
                                                                                        <td>
                                                                                           <button class="btn btn-xs btn-danger" onclick="deleteCarrierImageEdt({{@$row->id}})"><i class="fas fa-trash-alt"></i></button>
                                                                                        </td>
                                                                                     </tr>
                                                                                  @endforeach
                                                                               @endif
                                ...
                                <div class="tab-pane " id="notesce" role="tabpanel">
                                    <div class="rates_main">
                                        <form action="{{ route('addCarrierNoteEdt') }}" class="custom-validation" method="post" id="formValidatedNotes">
                                        @csrf
                                        <input type="hidden" name="carrier_id" value="{{ @$data['carrier_id'] }}">
                                            <div class="row row-border-bottom mt-3 mb-3">
                                                <div class="col-lg-6">
                                                                ...
                                                                <div class="modal fade" id="editConNote-{{ $row->id }}" tabindex="-1" role="dialog"
                                                                    ...
                                                                    <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <form action="{{ route('saveCarrierNoteEdt') }}" class="custom-validation"
                                                                                    method="post" id="formValidatedOtherAddress">
                                                                                    @csrf
                                                                                    <input type="hidden" name="carrier_id" value="{{ @$data['carrier_id'] }}">
                                                                                    <input type="hidden" name="note_id" value="{{ $row->id }}">
        ...
        <div class="modal fade" id="otherserviceadd" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('updateCarrierOtherAddressEdt') }}" class="custom-validation"
                            method="post" id="formValidatedOtherAddress">
                            @csrf
                            <input type="hidden" name="carrier_id" value="{{ @$data['carrier_id'] }}">
                            <div class="form-group mb-3">
