   ...
   <div class="page-content">
      <div class="container-fluid">
         ...
         <div class="card custom-shadow rounded-lg border">
            ...
            <div class="">
               <form action="{{ route('contacts') }}" class="custom-validation" method="post" id="formValidatedOtherAddress">
                  @csrf
                        ...
                        @foreach($list as $key=>$row)
                           ...
                           <tr>
                              ...
                              <td>
                                 ...
                                 <button data-toggle="tooltip" title="Delete User" class="btn btn-sm btn-danger" onclick="deleteHtsUsers({{ @$row->id }}, 'contacts')"><i class="fas fa-trash-alt"></i></button>
                              </td>
                           </tr>
