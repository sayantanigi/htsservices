                                ...
                                <div class="tab-pane " id="rates" role="tabpanel">
                                    <div class="rates_main">
                                        <div class="table-responsive fixhei">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <h4 class="card-title mb-3">Query Carrier Rates</h4>
                                                </div>
                                                <div class="table-responsive fixhei">
                                                    <table class="table table-hover mb-0">
                                                        <thead>
                                                        ...
                                                        <tbody>
                                                            @if (!empty($data['qscarrier_rates']))
                                                                @foreach ($data['qscarrier_rates'] as $key => $row_val)
                                                                    @php
                                                                        if(!empty($row_val->hts_transportationqr)) {
                                                                            $transportationData = DB::table('transportation')->where('id', $row_val->hts_transportationqr)->first();
                                                                        }
                                                                        if(!empty($row_val->hts_freight_service_classqr)) {
                                                                            $freight_service_classData = DB::table('freight_service_class')->where('id', $row_val->hts_freight_service_classqr)->first();
                                                                        }
                                                                        if(!empty($row_val->hts_careerqr)) {
                                                                            $hts_careerqr_classData = DB::table('hts_contacts')->where('id', $row_val->hts_careerqr)->first();
                                                                        }
                                                                    @endphp
                                                                    <tr>
                                                                        <td>{{ $loop->iteration }}</td>
                                                                        <td>
                                                                            @if ($row_val->hts_transportationqr)
                                                                                {{ $transportationData->description."/".$transportationData->method."/".$transportationData->code }}
                                                                            @else
                                                                                &#8212;
                                                                            @endif
                                                                        ...
                                                                        <td>
                                                                            @if (@$row_val->hts_freight_service_classqr)
                                                                                {{ $freight_service_classData->description."/".$freight_service_classData->code."/".$freight_service_classData->account_name }}
                                                                            @else
                                                                                &#8212;
                                                                            @endif
                                                                        ...
                                                                        <td>
                                                                            @if (@$row_val->hts_careerqr)
                                                                                {{ $hts_careerqr_classData->name." - ".$hts_careerqr_classData->entity_id }}
                                                                            @else
                                                                                &#8212;
                                                                            @endif
                                                                        </td>
                                                                        <td>
                                                                            @if (@$row_val->hts_currencyqr)
                                                                                {{ $row_val->hts_currencyqr }}
                                                                            @else
                                                                                &#8212;
                                                                            @endif
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            @if (@$row_val->hts_port_ladingqr)
                                                                                {{ $row_val->hts_port_ladingqr." / ".$row_val->hts_origincountryqr }}
                                                                            @else
                                                                                &#8212;
                                                                            @endif
                                                                        </td>
                                                                        <td>
                                                                            @if (@$row_val->hts_port_unladingqr)
                                                                                {{ $row_val->hts_port_unladingqr." / ".$row_val->hts_destinationcountryqr }}
                                                                            @else
                                                                                &#8212;
                                                                            @endif
                                                                        </td>
                                                                        <td>
                                                                            <button type="reset"
                                                                                class="btn btn-danger btn-sm waves-effect"
                                                                                onclick="deleteHtsQSRateGroundTabData({{ $row_val->id }});">
                                                                                <i class="fas fa-trash"></i> Delete
                                                                            </button>
                                                                        </td>
                                                                    </tr>
                                                                                    ...
                                                                                    <div class="col-6" style="display: inline-block; float: left; border-right: 2px solid #666;">
                                                                                        ...
                                                                                        <div class="col-lg-8 form-group" style="display: inline-block; float: left; padding: 0 10px 0 0;">
                                                                                            <div class="col-9" style="display: inline-block; float: left;">
                                                                                                ...
                                                                                                <select class="form-control form-select" name="hts_port_ladingqr" id="hts_port_ladingqr">
                                                                                                    ...
                                                                                                    @if (!$data['ports']->isEmpty())
                                                                                                        @foreach ($data['ports'] as $key => $item_val_1)
                                                                                                            <option value="{{ @$item_val_1->name }}" {{ @$item_val_1->name == @$data['rateData']->port_of_landing ? 'selected' : '' }}> {{ @$item_val_1->name }} - {{ @$item_val_1->port_id }}</option>
                                                                                                        @endforeach
                                                                                                    @endif
                                                                                                </select>
                                                                                            </div>
                                                                                        ...
                                                                                        <div class="col-lg-4 form-group" style="display: inline-block; float: left; padding: 0 10px 0 0;">
                                                                                            ...
                                                                                            <select class="form-select" name="hts_origincountryqr" id="hts_origincountryqr">
                                                                                                ...
                                                                                                @if (!$data['countries']->isEmpty())
                                                                                                @foreach ($data['countries'] as $key => $item_val)
                                                                                                <option value="{{ @$item_val->name }}" {{ @$item_val->name == @$data['rateData']->port_of_landing_country ? 'selected' : '' }}> {{ @$item_val->name }}</option>
                                                                                                @endforeach
                                                                                                @endif
                                                                                            </select>
                                                                                        </div>
