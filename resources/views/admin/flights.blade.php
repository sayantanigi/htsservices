               ...
               <table id="dataTable" class="table dt-responsive nowrap w-100">
                  <thead>
                     <tr>
                        ...
                        <th width="250">Passenger Flight</th>
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="square-switch">
                                    <input type="checkbox" id="square-switch{{ @$row->id }}" value="{{ @$row->status }}" switch="info" {{ (@$row->status == 1)? 'checked="checked"' : '' }} onchange="changeFlightStatus({{ @$row->id }}, $(this))" />
                              ...
                              <td>
                                 ...
                                 <button class="btn btn-sm btn-danger" onclick="deleteFlight({{ @$row->id }})"><i class="fas fa-trash-alt"></i></button>
                              </td>
                           </tr>
                              ...
                              <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                      <div class="modal-header">
                                          <h5 class="modal-title" id="staticBackdropLabel">Edit for {{ $row->fight_number }}</h5>
                                          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                      </div>
                                      <div class="modal-body">
                                       <form action="{{ route('updateFlight') }}" method="post" enctype="multipart/form-data" id="formValidated">
                                          @csrf
                                          ...
                                          <div class="row">
                                             <div class="col-lg-12">
                                                <div class="form-group mb-3">
                                                   <label class="fw-bold font-size-13">Number:</label>
                                                   <input type="text"  value="{{ $row->fight_number }}" required class="form-control" name="carrier_code_edt" id="carrier_code_edt">
                                                </div>
                                             </div>
                                          </div>
                                          ...
                                          <div class="row">
                                             <div class="col-lg-12">
                                                <div class="form-group mb-3">
                                                   <label class="fw-bold font-size-13">Passenger Flight:</label>
                                                   <textarea name="carrier_description_edt" class="form-control" required id="carrier_description_edt" rows="5">{{ $row->passenger }}</textarea>
                                                </div>
                                             </div>
                                          </div>
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" style="display: none;" aria-hidden="true">
   <div class="modal-dialog" role="document">
       <div class="modal-content">
           ...
           <div class="modal-body">
            <form action="{{ route('createFlight') }}" method="post" enctype="multipart/form-data" id="validateForm">
               @csrf
