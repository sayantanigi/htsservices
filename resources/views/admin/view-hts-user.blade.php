...
@section('content')
                                                                ...
                                                                <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form action="{{ route('saveHtsOtherAddress') }}" class="custom-validation"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="table-responsive">
                                                        <div style="max-height: 450px; overflow-y: auto;">
                                                            <form action="{{ route('updateHtsParentEntity') }}" class="custom-validation" method="post"
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="tab-content p-3 text-muted">
                                                                    ...
                                                                    <div class="tab-pane active" id="cgeneral" role="tabpanel">
                                                                        <form action="{{ route('createHtsContact') }}" class="custom-validation" method="post"
                                                                    ...
                                                                    <div class="tab-pane " id="cbaddress" role="tabpanel">
                                                                        <form action="{{ route('updateHtsConBillingAddress') }}" class="custom-validation"
                                                                    ...
                                                                    <div class="tab-pane " id="coaddress" role="tabpanel">
                                                                        <form action="{{ route('updateHtsContOtherAddress') }}" class="custom-validation"
                                                                    ...
                                                                    <div class="tab-pane " id="cpinfo" role="tabpanel">
                                                                        <form action="{{ route('updateHtsContDateOfBirth') }}" class="custom-validation"
                                                                                           ...
                                                                                           @if(!empty($data['contact_gallery']))
                                                                                              @foreach($data['contact_gallery'] as $key=>$row)
                                                                                                 ...
                                                                                                 <tr>
                                                                                                    ...
                                                                                                    <td>
                                                                                                       <button type="button" class="btn btn-xs btn-danger" onclick="deleteHtsListingImage({{@$row->id}})"><i class="fas fa-trash-alt"></i></button>
                                                                                                    </td>
                                                                                                 </tr>
                                                                                              @endforeach
                                                                                           @endif
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td>
                                                                                                            ...
                                                                                                            <button type="button" class="btn btn-danger btn-sm waves-effect"
                                                                                                                onclick="deleteHtsConNote({{ $row->id }});">
                                                                                                                <i class="fas fa-trash"></i> Delete
                                                                                                            </button>
                                                                                                        </td>
                                                                                                    ...
                                                                                                    <div class="modal fade" id="editConNote-{{ $row->id }}" tabindex="-1" role="dialog"
                                                                                                        ...
                                                                                                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                                                                                            <div class="modal-content">
                                                                                                                ...
                                                                                                                <div class="modal-body">
                                                                                                                    <form action="{{ route('saveHtsConNote') }}" class="custom-validation"
                                                                                                                        method="post" id="formValidatedOtherAddress">
                                                                                                                        @csrf
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="modal fade bs-air-aybills-modal-xl" id="myModalAirwaybills" role="dialog" aria-labelledby="addcontactdetails" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="addcontactdetails">Air Waybills
                                                            </h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" id="conModalClsCharge" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <form action="{{ route('create-awb-number') }}" class="custom-validation" method="post"
                                                                                id="formValidatedAWB">
                                                                        @csrf

                                                                        <div class="row mt-0 mb-3">
                                                                            <div class="col-lg-12">
                                                                                <h5 class="modal-title">Generate a range of Air Waybill Numbers
                                                                                </h5>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="row mt-3">
                                                                            <div class="col-lg-12">
                                                                                <div class="mb-3 ms-3 form-group">
                                                                                    ...
                                                                                    <input type="text" class="form-control" required placeholder="1000000" name="start_awb_number" value="{{ @$data['chargeData']->start_awb_numbers }}" >
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row mt-3">
                                                                            <div class="col-lg-12">
                                                                                <div class="mb-3 ms-3 form-group">
                                                                                    ...
                                                                                    <input type="text" class="form-control" required placeholder="9999999" name="end_awb_number" value="{{ @$data['chargeData']->end_awb_numbers }}" >
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-lg-4 form-group">
                                                                                    <select class="form-control form-select select2" name="hts_rate_method" id="hts_rate_method">
                                                                                        ...
                                                                                        <option value="Air">Air Rate</option>
                                                                                        <option value="Ocean">Ocean Rate</option>
                                                                                        <option value="Ground">Ground Rate</option>
                                                                                     </select>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row row-border-bottom mt-3 mb-3">
                                                                               ...
                                                                               @if(!empty($data['gallery']))
                                                                                  @foreach($data['gallery'] as $key=>$row)
                                                                                     ...
                                                                                     <tr>
                                                                                        ...
                                                                                        <td>
                                                                                           <button type="button" class="btn btn-xs btn-danger" onclick="deleteHtsMainListingImage({{ @$row->id }})"><i class="fas fa-trash-alt"></i></button>
                                                                                        </td>
                                                                                     </tr>
                                                                                  @endforeach
                                                                               @endif
        ...
        <div class="modal fade" id="otherserviceadd" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('updateHtsOtherAddress') }}" class="custom-validation"
                            method="post" id="formValidatedOtherAddress">
                            @csrf
                            <div class="form-group mb-3">
                                <label>Description<code>*</code></label>
    ...
    <script>
        ...
        // This script selects all input and button elements of type submit and hides them.
        document.querySelectorAll('input[type="submit"], button[type="submit"], button[type="button').forEach(function(element) {
